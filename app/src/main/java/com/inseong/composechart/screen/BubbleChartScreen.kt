...
import com.inseong.composechart.emptyBubbleData
import com.inseong.composechart.extremeBubbleData
import com.inseong.composechart.invalidBubbleData
import com.inseong.composechart.normalBubbleData
...
fun BubbleChartScreen(onBack: () -> Unit) {
    ...
    Column(
        ...
        Row(
            ...
            Text(text = "Bubble Chart", style = MaterialTheme.typography.headlineSmall)
        }
